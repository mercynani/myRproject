...
obj <- c(2, 2, 2.5, 2, 1, 1, 1, 1.5, 3, 1.5, 1.5, 1, 1, 2, 2, 1, 1, 2, 2, 2.5, 2.5)
mat <- matrix(c(1,1,1,1, 1,1,1,1), nrow = 4)
dir <- c(">=", ">=", ">=")
rhs <- c(420, 385, 455, 350)
min <- TRUE
...
options(digits = 10)
dimension <- 2
lower <- rep(-5.12, dimension) #lower limit of x values
